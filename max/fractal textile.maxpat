...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 517.0, 647.0, 188.0, 130.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 22.0, 334.0, 188.0, 130.0 ],
					"prototypename" : "pixl",
					"varname" : "kaleidr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 580.0, 291.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 122.0, 113.0, 69.0, 20.0 ],
					"text" : "dimension"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 408.0, 502.0, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 122.0, 9.0, 88.0, 88.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 257.156654000000003, 128.5, 50.0, 49.0 ],
					"text" : "size 4000. 4000."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 306.0, 31.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 278.0, 66.0, 63.0, 22.0 ],
					"text" : "size $1 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 826.0, 37.0, 375.843346000000111, 318.0 ],
					"text" : "複數平面（Complex-plane）\ncenter (x, y)\n迭代視窗在複數平面的中心座標。改它＝在平面上平移視角。\n程式用它計算 x1..y2，把畫面像素映到複數平面。\nzoom (scalar)\n視角縮放，採用 對數 方式：zoomFactor = exp(zoom)。\n值變大 ⇒ 放大，更靠近細節；變小 ⇒ 退遠。\n分形本體（Fractal / Julia）\nex (scalar)\n迭代的冪次 z = cpow(z, ex) + mu。\nex=2 是經典二次 Julia；ex=3,4… 會改變瓣數與對稱；非整數 也能玩，但對稱性會更怪。\nmu (x, y)\nJulia 的常數參數 \nc\nc。移動它會得到不同家族的 Julia 集（這裡是 Julia，不是 Mandelbrot，因為程式對每點用固定 mu 迭代）。\niter (int)\n最高迭代次數上限。越大越細，但成本越高。\niteroffset (int)\n暖機/跳過前幾次迭代的次數。從第 iteroffset 次開始才做 orbit trap 的取樣與混色。\n可用來避免前期軌道過於粗糙的影響。"
				}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.0, 833.0, 37.0, 22.0 ],
									"text" : "out 1"
								}
...
,
					"patching_rect" : [ 520.0, 611.0, 49.0, 22.0 ],
					"text" : "jit.gl.pix"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 113.0, 214.0, 60.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 28.0, 303.0, 37.0, 22.0 ],
					"text" : "reset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 28.0, 345.0, 71.0, 22.0 ],
					"text" : "jit.gl.handle"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 113.0, 245.0, 107.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 113.0, 277.0, 53.0, 22.0 ],
					"text" : "jit.matrix"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 113.0, 345.0, 92.5, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 22.0, 144.0, 188.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 28.0, 435.0, 447.0, 22.0 ],
					"text" : "jit.gl.gridshape cyano1 @shape torus @scale 0.65 0.65 0.65 @mat_diffuse 1 1 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 338.0, 166.5, 80.0, 35.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 58.0, 142.0, 53.0, 22.0 ],
					"text" : "s render"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 164.656654000000003, 69.0, 41.0, 22.0 ],
					"text" : "sel 49"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 154.156654000000003, 34.5, 50.5, 22.0 ],
					"text" : "key"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 608.843345999999883, 60.0, 61.0, 20.0 ],
					"text" : "preset"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 520.0, 290.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 22.0, 112.0, 92.5, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 520.0, 328.0, 61.0, 22.0 ],
					"text" : "dim $1 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 387.0, 549.0, 75.0, 22.0 ],
					"text" : "exportimage"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 387.0, 611.0, 53.0, 22.0 ],
					"text" : "jit.matrix"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 608.843345999999883, 89.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 284.0, 488.0, 73.0, 22.0 ],
					"text" : "loadmess 1."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 48.313308000000006, 64.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 284.0, 519.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 284.0, 551.0, 54.0, 22.0 ],
					"text" : "detail $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 19.156654000000003, 64.0, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 22.0, 9.0, 88.0, 88.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 19.156654000000003, 101.0, 236.0, 22.0 ],
					"text" : "jit.world cyano1 @size 1000 1000 @fsaa 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 565.843345999999883, 140.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 497.843345999999883, 239.0, 66.0, 22.0 ],
					"text" : "autopattr",
					"varname" : "u623002180"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 497.843345999999883, 80.0, 56.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 497.843345999999883, 140.0, 52.0, 22.0 ],
					"text" : "store $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 560.25, 173.0, 99.0, 22.0 ],
					"text" : "read pattern.json"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 497.843345999999883, 173.0, 38.0, 22.0 ],
					"text" : "write"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 497.843345999999883, 206.0, 153.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "jit_gl_texture", "", "" ],
					"patching_rect" : [ 520.0, 379.0, 542.0, 22.0 ],
					"text" : "jit.gl.node cyano1 @capture 1 @erase_color 0 0 0 1 @lighting_enable 0 @adapt 0 @dim 1000 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 517.0, 804.0, 243.0, 22.0 ],
					"text" : "jit.gl.videoplane cyano1 @transform_reset 2"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 584.0, 327.0, 142.0, 22.0 ],
					"text_width" : 42.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 520.0, 544.0, 150.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 22.0, 203.0, 188.0, 22.0 ],
					"text_width" : 70.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 673.0, 544.0, 150.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 22.0, 253.0, 188.0, 22.0 ],
					"text_width" : 70.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 826.0, 544.0, 150.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 22.0, 306.0, 188.0, 22.0 ],
					"text_width" : 71.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 979.0, 544.0, 150.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 22.0, 280.0, 188.0, 22.0 ],
					"text_width" : 71.0
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 520.0, 544.0, 150.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 22.0, 200.0, 188.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1134.0, 544.0, 150.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 22.0, 227.0, 188.0, 22.0 ],
					"text_width" : 71.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 520.0, 581.0, 150.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 22.0, 174.0, 188.0, 22.0 ],
					"text_width" : 68.0
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-11", 0 ],
					"midpoints" : [ 529.5, 488.0, 529.5, 488.0 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 137.156654000000003, 152.25, 347.5, 152.25 ],
					"order" : 0,
					"source" : [ "obj-68", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 137.156654000000003, 132.0, 67.5, 132.0 ],
					"order" : 1,
					"source" : [ "obj-68", 1 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-25::obj-17" : [ "range[1]", "range", 0 ],
			"obj-25::obj-24" : [ "Y offset", "Y offset", 0 ],
			"obj-25::obj-41" : [ "pictctrl[6]", "pictctrl[1]", 0 ],
			"obj-25::obj-47" : [ "pictctrl[7]", "pictctrl[1]", 0 ],
			"obj-25::obj-51" : [ "pictctrl[5]", "pictctrl[1]", 0 ],
			"obj-25::obj-53" : [ "pictctrl[8]", "pictctrl[1]", 0 ],
			"obj-25::obj-54" : [ "Bound mode", "Bound mode", 0 ],
			"obj-25::obj-56::obj-23" : [ "gswitch2[2]", "gswitch2", 0 ],
			"obj-25::obj-68" : [ "X offset", "X offset", 0 ],
			"obj-25::obj-94" : [ "Interp mode", "Interp mode", 0 ],
			"parameterbanks" : 			{
...
, 			{
				"name" : "pattern.json",
				"bootpath" : "~/Documents/Projects/Crowd_Supply_Campaign/LaserDyeProject/max",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
