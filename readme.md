# Teensy-4-galvos
This DIY laser galvonometer projector was originally designed for [Laser Dye Project](https://shihweichieh.com/Laser-Dye-Project-2015) to develop New Cyanotype and Vandyke brown images on sewn garments masklessly. It is also capable for other conventional application like engraving, PCB etching or audio visual performace. The software interface is made with max/msp and teensy code so the protocol is based on pure audio synthesis, not by ILDA, however the hardware is compatible with ILDA connectors and software too. You can [buy the mchine now on tindie](https://www.tindie.com/products/mice1/programmable-405nm-laser-galvo-system/).
